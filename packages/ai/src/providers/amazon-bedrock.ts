...
import { createEnvProxyAgents } from "../utils/node-proxy-agent.js";
import { hasProxyEnvironment } from "../utils/proxy-env.js";
	...
	(async () => {
		...
		if (typeof process !== "undefined" && (process.versions?.node || process.versions?.bun)) {
			...
			if (hasProxyEnvironment()) {
				...
				config.requestHandler = new NodeHttpHandler(createEnvProxyAgents());
